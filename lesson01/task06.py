"""
6.Задание: Спортсмен занимается ежедневными пробежками. В первый день его результат составил a километров.
...
start = float(input("Введите результат первого дня >>> "))  # a
