"""
6.Задание: Реализовать функцию int_func(), принимающую слово из маленьких латинских букв и возвращающую его же,
...
# Введите любое слово >>> роман
# Роман
# Введите строку через пробел >>> итак звалась она татьяна
