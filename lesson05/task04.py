...
with open("task04.txt", encoding='utf-8') as f:
    lines = f.readlines()
...
with open("task04_new.txt", "w", encoding='utf-8') as f2:
    f2.writelines(new_dict)

# В результате создался новый текстовый файл task04_new.txt с содержимым
# Один  — 1
# Два  — 2
# Три  — 3
# Четыре  — 4
