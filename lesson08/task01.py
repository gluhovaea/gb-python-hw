"""
1.Задание: Реализовать класс «Дата», функция-конструктор которого должна принимать дату в виде строки формата «день-месяц-год».
...
my_date = Date('25-02-2022')
# my_date = Date('25-00-2022')  # AssertionError: Неверный формат месяца
# my_date = Date('32-02-2022')  # AssertionError: Неверный формат числа
# my_date = Date('25-02-2101')  # AssertionError: Неверный формат года
